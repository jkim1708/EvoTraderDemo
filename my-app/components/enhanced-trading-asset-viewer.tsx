...
const EnhancedTradingAssetViewer = observer(() => {
    const {
        tradingRuleStore: { tradingRules, setTradingRule,setDefinedRefArea, currentSelectedTradeKind, setCurrentSelectedTradeKind, setCurrentTradingStrategyName },
    } = useStores();
                ...
                <CardContent>
                  ...
                  <span>
                    ...
                    P&L: {trade.profitNLoss}
                        ...
                        <div className="flex space-x-4 mb-4 flex justify-end">
